...
namespace Archiver_Beta
{
    public partial class Reports : Form
    {
        ...
        private void ExporttoExcel()
        {
            ...
            string connect = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\george\\OneDrive\\Projects\\Archiver\\Archiver-Beta\\Archiver-Beta\\Databases\\ArchiverDataBase.mdf;Integrated Security=True";
            ...
            {
                //opening savefiledialong when there is already made excel file
                //call our ToExcel method with parameters
        ...
        private void ToExcel(DataTable dt, string filename)
        {
            ...
            try
            {
                ...
                //we save the documents and showing an messagebox
        ...
        private void ToPDF(DataTable dt, string fileName)
        {
            try
            {
                ...
                gfx.DrawString("Exported Receipts", font, XBrushes.Black, new XRect(0, 0, width: page.Width,50), XStringFormats.Center);
